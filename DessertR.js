...
const data = [
  { id: '1', title: 'Salade de Fruits', image: require('./assets/salaefrui.jpg'), quantity: 0 },
  { id: '2', title: 'Tartelettes', image: require('./assets/tarteletes.jpg'), quantity: 0 },
  { id: '3', title: 'Jus Frais', image: require('./assets/jusfrais.jpg'), quantity: 0 },
  { id: '4', title: 'Glace', image: require('./assets/glaceR.jpg'), quantity: 0 },
];

const DessertR =  ({ navigation }) => {
