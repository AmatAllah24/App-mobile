...
const data = [
  { id: '1', title: 'Salade Oriental', image: require('./assets/saladeR.jpg'), quantity: 0 },
  { id: '2', title: 'Pastilla Duo', image: require('./assets/duo.jpg'), quantity: 0 },
  { id: '3', title: 'Poulet Farci', image: require('./assets/pouletfarci.jpg'), quantity: 0 },
  { id: '4', title: 'Tanjia', image: require('./assets/tanjia.jpg'), quantity: 0 },
];

const DinerR =  ({ navigation }) => {
